...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section 
  className="relative min-h-[850px] flex items-start bg-cover bg-center bg-no-repeat pt-72 sm:pt-[660px]"
  style={{ backgroundImage: `url(${heroBanner})` }}
>
  <div className="absolute inset-200 bg-black/40"></div>
  ...
  <div className="relative z-10 text-center text-white max-w-6xl mx-auto px-4">
    <div className="flex flex-col sm:flex-row gap-10 justify-center">
      ...
      >
        <Recycle className="mr-4" size={24} />
        Sell Scrap Now
      </Button>
      <Button 
        variant="secondary" 
